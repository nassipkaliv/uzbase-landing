...
export function Contact() {
  ...
  return (
    <section id="contact" className="py-20 lg:py-28 bg-surface border-t border-white/[0.06]">
      <Container>
        <div ref={ref} className="reveal">
          ...
          <div className="mb-12">
            ...
            <a
              ...
              className="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#F5F5F7] hover:text-accent transition-colors"
            >
          ...
          <div className="grid lg:grid-cols-2 gap-12 max-w-5xl">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                {/* Telegram */}
                <a href="https://t.me/UZBasestudio" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-[#F5F5F7] hover:text-accent transition-colors">
                ...
                {/* Instagram */}
                <a href="https://www.instagram.com/uzbase.studio" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-[#F5F5F7] hover:text-accent transition-colors">
                  <svg className="w-5 h-5 text-accent" fill="currentColor" viewBox="0 0 24 24">
                ...
                {/* YouTube */}
                <a href="https://youtube.com/@uzbase" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-sm text-[#F5F5F7] hover:text-accent transition-colors">
                  <svg className="w-5 h-5 text-accent" fill="currentColor" viewBox="0 0 24 24">
